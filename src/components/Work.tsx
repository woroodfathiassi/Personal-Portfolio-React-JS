...
const WorkItem = () => {
    ...
    return (
        <div className='w-full flex flex-col p-5 border-2 border-zinc-200 rounded-2xl dark:border-zinc-800 '>
            <h2 className='flex gap-2 items-center mt-3 mb-7 text-zinc-900 dark:text-zinc-100'>

...
const ProjectsPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Projects | Worood Assi - Front-end Developer</title>
                <meta
                    name="description"
                    content="Explore a curated selection of projects from my university journey, showcasing the skills and knowledge I've acquired."
                />
